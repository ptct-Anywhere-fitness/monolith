export const calc_days_in_month = (year, month) =>
  ...
  [-1e10, 31, year % 4 === 0 ? 29 : 28, 31, 30, 31, 30, 31, 31, 30, 31, 30, 31][
    month
  ];
...
export const date2day = (year, month, _date_) => {
  ...
  const days_so_far_in_current_year = calc_days_so_far_in_current_year(
    year,
    month,
    _date_
  );
  ...
  if (years_since_2021 > 0) {
    ...
    date_idx =
      days_so_far_in_current_year + days_in_years_between_2021_and_current_year;
    // console.log('year: ', year, ',  month: ', month, ',  _date_: ', _date_,  'idx1: ', idx1, ',  idx2: ', idx2);
  } else if (years_since_2021 < 0) {
    // year < 2021
    // TODO: Throw error!
  } else {
...
//   // 4. calc_days_so_far_in_current_year(2021, 12, 31) === 365
//   // 5. calc_days_so_far_in_current_year(2020, 12, 31) === 366
//   if (date2day(2021, 1, 1) !== 'fri') console.error('date2day error! 1');
//   if (date2day(2021, 1, 31) !== 'sun') console.error('date2day error! 2');
//   if (date2day(2021, 2, 1) !== 'mon') console.error('date2day error! 3');
//   if (date2day(2021, 12, 31) !== 'fri') console.error('date2day error! 4');
//   if (date2day(2022, 1, 1) !== 'sat') console.error('date2day error! 5');
...
//     console.error(
//       'date2day error! 6... date2day(2024, 2, 29): ',
//       date2day(2024, 2, 29)
//     );
//   if (date2day(2024, 12, 31) !== 'tue')
//     console.error(
//       'date2day error! 7... date2day(2024, 12, 31): ',
//       date2day(2024, 12, 31)
//     );
//   if (date2day(2025, 1, 1) !== 'wed')
//     console.error(
//       'date2day error! 8... date2day(2025, 1, 1): ',
//       date2day(2025, 1, 1)
//     );
